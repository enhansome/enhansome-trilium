...
A curated list of awesome [Trilium Notes](https://github.com/zadam/trilium) ⭐ 37,397 | 🐛 672 | 🌐 TypeScript | 📅 2026-08-13 extensions. Including themes, widgets,
...
* [Evernote](https://github.com/zadam/trilium/wiki/Evernote-import) ⭐ 37,397 | 🐛 672 | 🌐 TypeScript | 📅 2026-08-13 (Trilium Wiki Guide) The most recent version of the
  ...
  the following tool: <https://github.com/vzhd1701/evernote-backup> ⭐ 1,700 | 🐛 5 | 🌐 Python | 📅 2026-08-10.
* [HTML](https://github.com/zadam/trilium/wiki/Markdown) ⭐ 37,397 | 🐛 672 | 🌐 TypeScript | 📅 2026-08-13 Supported Natively
* [Markdown](https://github.com/zadam/trilium/wiki/Markdown) ⭐ 37,397 | 🐛 672 | 🌐 TypeScript | 📅 2026-08-13 Supported Natively
* [OneNote](https://github.com/zadam/trilium/wiki/Onenote) ⭐ 37,397 | 🐛 672 | 🌐 TypeScript | 📅 2026-08-13 (Trilium Wiki Guide)
* [Text](https://github.com/zadam/trilium/wiki/Markdown) ⭐ 37,397 | 🐛 672 | 🌐 TypeScript | 📅 2026-08-13 Supported Natively
...
css note. See [Styling the shared notes](https://github.com/zadam/trilium/wiki/Sharing#styling-the-shared-notes) ⭐ 37,397 | 🐛 672 | 🌐 TypeScript | 📅 2026-08-13 for
more info.

* [ysslang's theme](https://github.com/zadam/trilium/discussions/2681) ⭐ 37,397 | 🐛 672 | 🌐 TypeScript | 📅 2026-08-13 ![ysslang's theme](https://img.shields.io/github/gist/last-commit/46e2a57ca95ba9c7368cbd255d1ac769)
...
See ([Trilium Wiki](https://github.com/zadam/trilium/wiki/Themes#custom-css) ⭐ 37,397 | 🐛 672 | 🌐 TypeScript | 📅 2026-08-13
for instructions on how to enable custom CSS)

* [display edited notes as list](https://github.com/zadam/trilium/discussions/2670#discussion-3884786) ⭐ 37,397 | 🐛 672 | 🌐 TypeScript | 📅 2026-08-13
* [horizontal scrollbar](https://github.com/zadam/trilium/discussions/4706) ⭐ 37,397 | 🐛 672 | 🌐 TypeScript | 📅 2026-08-13 A css snippet to make the left panel and toc display a horizontal scrollbar.
* [remove numbers from table of contents](https://github.com/zadam/trilium/discussions/3873#discussioncomment-5710601) ⭐ 37,397 | 🐛 672 | 🌐 TypeScript | 📅 2026-08-13
* [vertical lines for tree](https://github.com/zadam/trilium/issues/3892#issuecomment-1530144842) ⭐ 37,397 | 🐛 672 | 🌐 TypeScript | 📅 2026-08-13
...
* [active calendar days visibility improvement](https://github.com/Nriver/awesome-trilium/issues/30) ⭐ 923 | 🐛 4 | 📅 2026-08-11
* [zen mode](https://github.com/Nriver/awesome-trilium/issues/44) ⭐ 923 | 🐛 4 | 📅 2026-08-11 Add zen mode to your Trilium.
...
* [Convert formulas in Note](https://github.com/zadam/trilium/discussions/4792) ⭐ 37,397 | 🐛 672 | 🌐 TypeScript | 📅 2026-08-13
  Convert math formulas wrapped in single dollar signs `$` and double dollar signs `$$` into HTML format within Trilium Notes
* [Scratchpad](https://github.com/zadam/trilium/discussions/1613#discussioncomment-638984) ⭐ 37,397 | 🐛 672 | 🌐 TypeScript | 📅 2026-08-13
...
* [trilium-simple-mind-map](https://github.com/waterovo/trilium-simple-mind-map) ⭐ 36 | 🐛 7 | 🌐 JavaScript | 📅 2025-04-19 ![trilium-simple-mind-map](https://img.shields.io/github/last-commit/waterovo/trilium-simple-mind-map)
  Create [simple-mind-map](https://github.com/wanglin2/mind-map) ⭐ 12,588 | 🐛 132 | 🌐 JavaScript | 📅 2026-08-02 mindmap in Trilium.
...
* [Calendar Sunday First](https://github.com/zadam/trilium/discussions/4540) ⭐ 37,397 | 🐛 672 | 🌐 TypeScript | 📅 2026-08-13
  Use Sunday as first weekday in calendar.
* [Dark-mode-img-color-conversion](https://github.com/zadam/trilium/discussions/4209) ⭐ 37,397 | 🐛 672 | 🌐 TypeScript | 📅 2026-08-13
  Adjusting the images and background colors on the web page to suit a dark theme.
* [Font formatting shortcuts](https://github.com/zadam/trilium/issues/2954#issuecomment-1672431589) ⭐ 37,397 | 🐛 672 | 🌐 TypeScript | 📅 2026-08-13
  Customizable shortcut keys for text formatting in CKEditor. Makes significant enhancement in editing efficiency.
* [Open note in split view](https://github.com/zadam/trilium/discussions/3937) ⭐ 37,397 | 🐛 672 | 🌐 TypeScript | 📅 2026-08-13
...
* [Run Trilium Server in Termux on Android](https://github.com/zadam/trilium/discussions/4542) ⭐ 37,397 | 🐛 672 | 🌐 TypeScript | 📅 2026-08-13 Your server in your hand.
  Have fun :)
...
* [singlefile2trilium](https://github.com/nil0x42/singlefile2trilium) ⭐ 112 | 🐛 2 | 🌐 Python | 📅 2022-05-26 ![singlefile2trilium](https://img.shields.io/github/last-commit/nil0x42/singlefile2trilium)
  With the power of [SingleFile](https://github.com/gildas-lormeau/SingleFile) ⭐ 22,143 | 🐛 159 | 🌐 JavaScript | 📅 2026-08-05 web extension, you can get a perfect copy
...
Trilium's external API (aka [ETAPI](https://github.com/zadam/trilium/wiki/ETAPI) ⭐ 37,397 | 🐛 672 | 🌐 TypeScript | 📅 2026-08-13) related stuff.
...
* [official wiki](https://github.com/zadam/trilium/wiki) ⭐ 37,397 | 🐛 672 | 🌐 TypeScript | 📅 2026-08-13
