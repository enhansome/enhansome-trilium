...
A curated list of awesome [Trilium Notes](https://github.com/zadam/trilium) ⭐ 37,633 | 🐛 702 | 🌐 TypeScript | 📅 2026-08-29 extensions. Including themes, widgets,
...
* [Evernote](https://github.com/zadam/trilium/wiki/Evernote-import) ⭐ 37,633 | 🐛 702 | 🌐 TypeScript | 📅 2026-08-29 (Trilium Wiki Guide) The most recent version of the
...
* [HTML](https://github.com/zadam/trilium/wiki/Markdown) ⭐ 37,633 | 🐛 702 | 🌐 TypeScript | 📅 2026-08-29 Supported Natively
* [Markdown](https://github.com/zadam/trilium/wiki/Markdown) ⭐ 37,633 | 🐛 702 | 🌐 TypeScript | 📅 2026-08-29 Supported Natively
* [OneNote](https://github.com/zadam/trilium/wiki/Onenote) ⭐ 37,633 | 🐛 702 | 🌐 TypeScript | 📅 2026-08-29 (Trilium Wiki Guide)
* [Text](https://github.com/zadam/trilium/wiki/Markdown) ⭐ 37,633 | 🐛 702 | 🌐 TypeScript | 📅 2026-08-29 Supported Natively
...
css note. See [Styling the shared notes](https://github.com/zadam/trilium/wiki/Sharing#styling-the-shared-notes) ⭐ 37,633 | 🐛 702 | 🌐 TypeScript | 📅 2026-08-29 for
more info.

* [ysslang's theme](https://github.com/zadam/trilium/discussions/2681) ⭐ 37,633 | 🐛 702 | 🌐 TypeScript | 📅 2026-08-29 ![ysslang's theme](https://img.shields.io/github/gist/last-commit/46e2a57ca95ba9c7368cbd255d1ac769)
...
* [zfy theme](https://github.com/brucevon/zfy) ⭐ 4 | 🐛 0 | 🌐 EJS | 📅 2026-08-29 ![zfy theme](https://img.shields.io/github/last-commit/brucevon/zfy)
...
See ([Trilium Wiki](https://github.com/zadam/trilium/wiki/Themes#custom-css) ⭐ 37,633 | 🐛 702 | 🌐 TypeScript | 📅 2026-08-29
for instructions on how to enable custom CSS)

* [display edited notes as list](https://github.com/zadam/trilium/discussions/2670#discussion-3884786) ⭐ 37,633 | 🐛 702 | 🌐 TypeScript | 📅 2026-08-29
* [horizontal scrollbar](https://github.com/zadam/trilium/discussions/4706) ⭐ 37,633 | 🐛 702 | 🌐 TypeScript | 📅 2026-08-29 A css snippet to make the left panel and toc display a horizontal scrollbar.
* [remove numbers from table of contents](https://github.com/zadam/trilium/discussions/3873#discussioncomment-5710601) ⭐ 37,633 | 🐛 702 | 🌐 TypeScript | 📅 2026-08-29
* [vertical lines for tree](https://github.com/zadam/trilium/issues/3892#issuecomment-1530144842) ⭐ 37,633 | 🐛 702 | 🌐 TypeScript | 📅 2026-08-29
...
* [Convert formulas in Note](https://github.com/zadam/trilium/discussions/4792) ⭐ 37,633 | 🐛 702 | 🌐 TypeScript | 📅 2026-08-29
  Convert math formulas wrapped in single dollar signs `$` and double dollar signs `$$` into HTML format within Trilium Notes
* [Scratchpad](https://github.com/zadam/trilium/discussions/1613#discussioncomment-638984) ⭐ 37,633 | 🐛 702 | 🌐 TypeScript | 📅 2026-08-29
...
* [Calendar Sunday First](https://github.com/zadam/trilium/discussions/4540) ⭐ 37,633 | 🐛 702 | 🌐 TypeScript | 📅 2026-08-29
  Use Sunday as first weekday in calendar.
* [Dark-mode-img-color-conversion](https://github.com/zadam/trilium/discussions/4209) ⭐ 37,633 | 🐛 702 | 🌐 TypeScript | 📅 2026-08-29
  Adjusting the images and background colors on the web page to suit a dark theme.
* [Font formatting shortcuts](https://github.com/zadam/trilium/issues/2954#issuecomment-1672431589) ⭐ 37,633 | 🐛 702 | 🌐 TypeScript | 📅 2026-08-29
  Customizable shortcut keys for text formatting in CKEditor. Makes significant enhancement in editing efficiency.
* [Open note in split view](https://github.com/zadam/trilium/discussions/3937) ⭐ 37,633 | 🐛 702 | 🌐 TypeScript | 📅 2026-08-29
...
* [Run Trilium Server in Termux on Android](https://github.com/zadam/trilium/discussions/4542) ⭐ 37,633 | 🐛 702 | 🌐 TypeScript | 📅 2026-08-29 Your server in your hand.
  Have fun :)
...
Trilium's external API (aka [ETAPI](https://github.com/zadam/trilium/wiki/ETAPI) ⭐ 37,633 | 🐛 702 | 🌐 TypeScript | 📅 2026-08-29) related stuff.
...
* [official wiki](https://github.com/zadam/trilium/wiki) ⭐ 37,633 | 🐛 702 | 🌐 TypeScript | 📅 2026-08-29
