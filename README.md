...
A curated list of awesome [Trilium Notes](https://github.com/zadam/trilium) ⭐ 37,765 | 🐛 679 | 🌐 TypeScript | 📅 2026-09-08 extensions. Including themes, widgets,
...
* [Evernote](https://github.com/zadam/trilium/wiki/Evernote-import) ⭐ 37,765 | 🐛 679 | 🌐 TypeScript | 📅 2026-09-08 (Trilium Wiki Guide) The most recent version of the
  ...
  the following tool: <https://github.com/vzhd1701/evernote-backup> ⭐ 1,734 | 🐛 4 | 🌐 Python | 📅 2026-08-10.
* [HTML](https://github.com/zadam/trilium/wiki/Markdown) ⭐ 37,765 | 🐛 679 | 🌐 TypeScript | 📅 2026-09-08 Supported Natively
* [Markdown](https://github.com/zadam/trilium/wiki/Markdown) ⭐ 37,765 | 🐛 679 | 🌐 TypeScript | 📅 2026-09-08 Supported Natively
* [OneNote](https://github.com/zadam/trilium/wiki/Onenote) ⭐ 37,765 | 🐛 679 | 🌐 TypeScript | 📅 2026-09-08 (Trilium Wiki Guide)
* [Text](https://github.com/zadam/trilium/wiki/Markdown) ⭐ 37,765 | 🐛 679 | 🌐 TypeScript | 📅 2026-09-08 Supported Natively
* [Joplin](https://github.com/Nriver/trilium-py#import-from-joplin) ⭐ 231 | 🐛 4 | 🌐 Python | 📅 2026-05-26 Can be imported with trilium-py.
* [Logseq](https://github.com/Nriver/trilium-py#import-from-logseq) ⭐ 231 | 🐛 4 | 🌐 Python | 📅 2026-05-26 Can be imported with trilium-py.
* [Obsidian](https://github.com/Nriver/trilium-py#import-from-obsidian) ⭐ 231 | 🐛 4 | 🌐 Python | 📅 2026-05-26 Need to convert a Obsidian vault to regular
  Markdown files first. Then import with trilium-py to handle obisdian's unique linking format. See more in the link.
* [Turtl](https://github.com/Nriver/trilium-py/tree/main/examples/turtl-to-markdown) ⭐ 231 | 🐛 4 | 🌐 Python | 📅 2026-05-26 Convert Turtl notes to markdown
  directory
* [Youdao Note/有道云笔记](https://github.com/Nriver/trilium-py#import-from-youdao-note%E6%9C%89%E9%81%93%E4%BA%91%E7%AC%94%E8%AE%B0) ⭐ 231 | 🐛 4 | 🌐 Python | 📅 2026-05-26
  Requires to download notes and convert to markdown. More details are in the link.
* [VNote](https://github.com/Nriver/trilium-py#import-from-vnote) ⭐ 231 | 🐛 4 | 🌐 Python | 📅 2026-05-26 Can be imported with trilium-py. The special image
  format will be well handled.
* [Zotero](https://github.com/paulusm/zotero-trilium) ⭐ 39 | 🐛 0 | 🌐 JavaScript | 📅 2026-04-16 A Zotero plugin to export notes to Trillium notes
...
css note. See [Styling the shared notes](https://github.com/zadam/trilium/wiki/Sharing#styling-the-shared-notes) ⭐ 37,765 | 🐛 679 | 🌐 TypeScript | 📅 2026-09-08 for
more info.

* [ysslang's theme](https://github.com/zadam/trilium/discussions/2681) ⭐ 37,765 | 🐛 679 | 🌐 TypeScript | 📅 2026-09-08 ![ysslang's theme](https://img.shields.io/github/gist/last-commit/46e2a57ca95ba9c7368cbd255d1ac769)
...
See ([Trilium Wiki](https://github.com/zadam/trilium/wiki/Themes#custom-css) ⭐ 37,765 | 🐛 679 | 🌐 TypeScript | 📅 2026-09-08
for instructions on how to enable custom CSS)

* [display edited notes as list](https://github.com/zadam/trilium/discussions/2670#discussion-3884786) ⭐ 37,765 | 🐛 679 | 🌐 TypeScript | 📅 2026-09-08
* [horizontal scrollbar](https://github.com/zadam/trilium/discussions/4706) ⭐ 37,765 | 🐛 679 | 🌐 TypeScript | 📅 2026-09-08 A css snippet to make the left panel and toc display a horizontal scrollbar.
* [remove numbers from table of contents](https://github.com/zadam/trilium/discussions/3873#discussioncomment-5710601) ⭐ 37,765 | 🐛 679 | 🌐 TypeScript | 📅 2026-09-08
* [vertical lines for tree](https://github.com/zadam/trilium/issues/3892#issuecomment-1530144842) ⭐ 37,765 | 🐛 679 | 🌐 TypeScript | 📅 2026-09-08
...
* [active calendar days visibility improvement](https://github.com/Nriver/awesome-trilium/issues/30) ⭐ 940 | 🐛 4 | 📅 2026-08-11
* [zen mode](https://github.com/Nriver/awesome-trilium/issues/44) ⭐ 940 | 🐛 4 | 📅 2026-08-11 Add zen mode to your Trilium.
...
* [Convert formulas in Note](https://github.com/zadam/trilium/discussions/4792) ⭐ 37,765 | 🐛 679 | 🌐 TypeScript | 📅 2026-09-08
  Convert math formulas wrapped in single dollar signs `$` and double dollar signs `$$` into HTML format within Trilium Notes
* [Scratchpad](https://github.com/zadam/trilium/discussions/1613#discussioncomment-638984) ⭐ 37,765 | 🐛 679 | 🌐 TypeScript | 📅 2026-09-08
...
* [trilium-simple-mind-map](https://github.com/waterovo/trilium-simple-mind-map) ⭐ 36 | 🐛 7 | 🌐 JavaScript | 📅 2025-04-19 ![trilium-simple-mind-map](https://img.shields.io/github/last-commit/waterovo/trilium-simple-mind-map)
  Create [simple-mind-map](https://github.com/wanglin2/mind-map) ⭐ 12,687 | 🐛 133 | 🌐 JavaScript | 📅 2026-08-02 mindmap in Trilium.
...
* [Calendar Sunday First](https://github.com/zadam/trilium/discussions/4540) ⭐ 37,765 | 🐛 679 | 🌐 TypeScript | 📅 2026-09-08
  Use Sunday as first weekday in calendar.
* [Dark-mode-img-color-conversion](https://github.com/zadam/trilium/discussions/4209) ⭐ 37,765 | 🐛 679 | 🌐 TypeScript | 📅 2026-09-08
  Adjusting the images and background colors on the web page to suit a dark theme.
* [Font formatting shortcuts](https://github.com/zadam/trilium/issues/2954#issuecomment-1672431589) ⭐ 37,765 | 🐛 679 | 🌐 TypeScript | 📅 2026-09-08
  Customizable shortcut keys for text formatting in CKEditor. Makes significant enhancement in editing efficiency.
* [Open note in split view](https://github.com/zadam/trilium/discussions/3937) ⭐ 37,765 | 🐛 679 | 🌐 TypeScript | 📅 2026-09-08
...
* [Beatlink's Trilium Scripts](https://github.com/BeatLink/trilium-scripts) ⭐ 61 | 🐛 0 | 🌐 JavaScript | 📅 2026-09-02 A collection of scripts and widgets to do everything from allowing you to set priority colors on Notes, to scripting recurring To-dos.
* [Mobile View](https://github.com/BeatLink/trilium-scripts/tree/main/Mobile%20View) ⭐ 61 | 🐛 0 | 🌐 JavaScript | 📅 2026-09-02 ![Mobile View](https://img.shields.io/github/last-commit/BeatLink/trilium-scripts)
...
* [Trillium Agenda](https://github.com/BeatLink/trilium-agenda) ⭐ 61 | 🐛 0 | 🌐 JavaScript | 📅 2026-09-02 ![Trillium Agenda](https://img.shields.io/github/last-commit/BeatLink/trilium-agenda)
...
* [drawio](https://github.com/SiriusXT/trilium-drawio) ⭐ 114 | 🐛 5 | 🌐 JavaScript | 📅 2026-07-25 ![drawio](https://img.shields.io/github/last-commit/SiriusXT/trilium-drawio)
...
* [Gantt TODO Panel](https://github.com/youli42/Trilium-TodoList) ⭐ 9 | 🐛 1 | 🌐 JavaScript | 📅 2026-06-27 ![Gantt TODO Panel](https://img.shields.io/github/last-commit/youli42/Trilium-TodoList)
...
* [Run Trilium Server in Termux on Android](https://github.com/zadam/trilium/discussions/4542) ⭐ 37,765 | 🐛 679 | 🌐 TypeScript | 📅 2026-09-08 Your server in your hand.
  Have fun :)
* [TriliumDroid](https://github.com/FliegendeWurst/TriliumDroid) ⭐ 393 | 🐛 48 | 🌐 Kotlin | 📅 2026-09-01 ![TriliumDroid](https://img.shields.io/github/last-commit/FliegendeWurst/TriliumDroid)
  Unofficial port of Trilium to Android, in beta
* [Pocket Trilium](https://github.com/nriver/pocket-trilium) ⭐ 133 | 🐛 7 | 🌐 Dart | 📅 2026-09-03 ![pocket-trilium](https://img.shields.io/github/last-commit/nriver/pocket-trilium)
...
* [singlefile2trilium](https://github.com/nil0x42/singlefile2trilium) ⭐ 112 | 🐛 2 | 🌐 Python | 📅 2022-05-26 ![singlefile2trilium](https://img.shields.io/github/last-commit/nil0x42/singlefile2trilium)
  With the power of [SingleFile](https://github.com/gildas-lormeau/SingleFile) ⭐ 22,344 | 🐛 102 | 🌐 JavaScript | 📅 2026-09-07 web extension, you can get a perfect copy
...
Trilium's external API (aka [ETAPI](https://github.com/zadam/trilium/wiki/ETAPI) ⭐ 37,765 | 🐛 679 | 🌐 TypeScript | 📅 2026-09-08) related stuff.

### 🦾 ETAPI client

The client implementations for ETAPI.

* [trilium-py](https://github.com/Nriver/trilium-py) ⭐ 231 | 🐛 4 | 🌐 Python | 📅 2026-05-26 ![trilium-py](https://img.shields.io/github/last-commit/Nriver/trilium-py)
...
* [Trilium2typecho](https://gitee.com/gkm0/trilium2typecho)
  ...
  A demo Telegram bot for Trilium, powered by [trilium-py](https://github.com/Nriver/trilium-py) ⭐ 231 | 🐛 4 | 🌐 Python | 📅 2026-05-26.
* [zotero-trilium](https://github.com/paulusm/zotero-trilium) ⭐ 39 | 🐛 0 | 🌐 JavaScript | 📅 2026-04-16 ![zotero-trilium](https://img.shields.io/github/last-commit/paulusm/zotero-trilium)
...
* [official wiki](https://github.com/zadam/trilium/wiki) ⭐ 37,765 | 🐛 679 | 🌐 TypeScript | 📅 2026-09-08
...
by <https://github.com/ekalinin/github-markdown-toc> ⭐ 3,299 | 🐛 24 | 🌐 Shell | 📅 2024-10-12. Then reformatted
