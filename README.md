...
A curated list of awesome [Trilium Notes](https://github.com/zadam/trilium) ⭐ 37,775 | 🐛 681 | 🌐 TypeScript | 📅 2026-09-09 extensions. Including themes, widgets,
...
* [Evernote](https://github.com/zadam/trilium/wiki/Evernote-import) ⭐ 37,775 | 🐛 681 | 🌐 TypeScript | 📅 2026-09-09 (Trilium Wiki Guide) The most recent version of the
  ...
  the following tool: <https://github.com/vzhd1701/evernote-backup> ⭐ 1,735 | 🐛 4 | 🌐 Python | 📅 2026-08-10.
* [HTML](https://github.com/zadam/trilium/wiki/Markdown) ⭐ 37,775 | 🐛 681 | 🌐 TypeScript | 📅 2026-09-09 Supported Natively
* [Markdown](https://github.com/zadam/trilium/wiki/Markdown) ⭐ 37,775 | 🐛 681 | 🌐 TypeScript | 📅 2026-09-09 Supported Natively
* [OneNote](https://github.com/zadam/trilium/wiki/Onenote) ⭐ 37,775 | 🐛 681 | 🌐 TypeScript | 📅 2026-09-09 (Trilium Wiki Guide)
* [Text](https://github.com/zadam/trilium/wiki/Markdown) ⭐ 37,775 | 🐛 681 | 🌐 TypeScript | 📅 2026-09-09 Supported Natively
...
css note. See [Styling the shared notes](https://github.com/zadam/trilium/wiki/Sharing#styling-the-shared-notes) ⭐ 37,775 | 🐛 681 | 🌐 TypeScript | 📅 2026-09-09 for
more info.

* [ysslang's theme](https://github.com/zadam/trilium/discussions/2681) ⭐ 37,775 | 🐛 681 | 🌐 TypeScript | 📅 2026-09-09 ![ysslang's theme](https://img.shields.io/github/gist/last-commit/46e2a57ca95ba9c7368cbd255d1ac769)
...
See ([Trilium Wiki](https://github.com/zadam/trilium/wiki/Themes#custom-css) ⭐ 37,775 | 🐛 681 | 🌐 TypeScript | 📅 2026-09-09
for instructions on how to enable custom CSS)

* [display edited notes as list](https://github.com/zadam/trilium/discussions/2670#discussion-3884786) ⭐ 37,775 | 🐛 681 | 🌐 TypeScript | 📅 2026-09-09
* [horizontal scrollbar](https://github.com/zadam/trilium/discussions/4706) ⭐ 37,775 | 🐛 681 | 🌐 TypeScript | 📅 2026-09-09 A css snippet to make the left panel and toc display a horizontal scrollbar.
* [remove numbers from table of contents](https://github.com/zadam/trilium/discussions/3873#discussioncomment-5710601) ⭐ 37,775 | 🐛 681 | 🌐 TypeScript | 📅 2026-09-09
* [vertical lines for tree](https://github.com/zadam/trilium/issues/3892#issuecomment-1530144842) ⭐ 37,775 | 🐛 681 | 🌐 TypeScript | 📅 2026-09-09
...
* [Convert formulas in Note](https://github.com/zadam/trilium/discussions/4792) ⭐ 37,775 | 🐛 681 | 🌐 TypeScript | 📅 2026-09-09
  Convert math formulas wrapped in single dollar signs `$` and double dollar signs `$$` into HTML format within Trilium Notes
* [Scratchpad](https://github.com/zadam/trilium/discussions/1613#discussioncomment-638984) ⭐ 37,775 | 🐛 681 | 🌐 TypeScript | 📅 2026-09-09
...
* [trilium-simple-mind-map](https://github.com/waterovo/trilium-simple-mind-map) ⭐ 36 | 🐛 7 | 🌐 JavaScript | 📅 2025-04-19 ![trilium-simple-mind-map](https://img.shields.io/github/last-commit/waterovo/trilium-simple-mind-map)
  Create [simple-mind-map](https://github.com/wanglin2/mind-map) ⭐ 12,689 | 🐛 133 | 🌐 JavaScript | 📅 2026-08-02 mindmap in Trilium.
...
* [Calendar Sunday First](https://github.com/zadam/trilium/discussions/4540) ⭐ 37,775 | 🐛 681 | 🌐 TypeScript | 📅 2026-09-09
  Use Sunday as first weekday in calendar.
* [Dark-mode-img-color-conversion](https://github.com/zadam/trilium/discussions/4209) ⭐ 37,775 | 🐛 681 | 🌐 TypeScript | 📅 2026-09-09
  Adjusting the images and background colors on the web page to suit a dark theme.
* [Font formatting shortcuts](https://github.com/zadam/trilium/issues/2954#issuecomment-1672431589) ⭐ 37,775 | 🐛 681 | 🌐 TypeScript | 📅 2026-09-09
  Customizable shortcut keys for text formatting in CKEditor. Makes significant enhancement in editing efficiency.
* [Open note in split view](https://github.com/zadam/trilium/discussions/3937) ⭐ 37,775 | 🐛 681 | 🌐 TypeScript | 📅 2026-09-09
...
* [Run Trilium Server in Termux on Android](https://github.com/zadam/trilium/discussions/4542) ⭐ 37,775 | 🐛 681 | 🌐 TypeScript | 📅 2026-09-09 Your server in your hand.
  Have fun :)
...
* [singlefile2trilium](https://github.com/nil0x42/singlefile2trilium) ⭐ 112 | 🐛 2 | 🌐 Python | 📅 2022-05-26 ![singlefile2trilium](https://img.shields.io/github/last-commit/nil0x42/singlefile2trilium)
  With the power of [SingleFile](https://github.com/gildas-lormeau/SingleFile) ⭐ 22,351 | 🐛 102 | 🌐 JavaScript | 📅 2026-09-07 web extension, you can get a perfect copy
...
Trilium's external API (aka [ETAPI](https://github.com/zadam/trilium/wiki/ETAPI) ⭐ 37,775 | 🐛 681 | 🌐 TypeScript | 📅 2026-09-09) related stuff.
...
* [official wiki](https://github.com/zadam/trilium/wiki) ⭐ 37,775 | 🐛 681 | 🌐 TypeScript | 📅 2026-09-09
