...
A curated list of awesome [Trilium Notes](https://github.com/zadam/trilium) ⭐ 37,518 | 🐛 666 | 🌐 TypeScript | 📅 2026-08-20 extensions. Including themes, widgets,
...
* [Evernote](https://github.com/zadam/trilium/wiki/Evernote-import) ⭐ 37,518 | 🐛 666 | 🌐 TypeScript | 📅 2026-08-20 (Trilium Wiki Guide) The most recent version of the
...
* [HTML](https://github.com/zadam/trilium/wiki/Markdown) ⭐ 37,518 | 🐛 666 | 🌐 TypeScript | 📅 2026-08-20 Supported Natively
* [Markdown](https://github.com/zadam/trilium/wiki/Markdown) ⭐ 37,518 | 🐛 666 | 🌐 TypeScript | 📅 2026-08-20 Supported Natively
* [OneNote](https://github.com/zadam/trilium/wiki/Onenote) ⭐ 37,518 | 🐛 666 | 🌐 TypeScript | 📅 2026-08-20 (Trilium Wiki Guide)
* [Text](https://github.com/zadam/trilium/wiki/Markdown) ⭐ 37,518 | 🐛 666 | 🌐 TypeScript | 📅 2026-08-20 Supported Natively
...
css note. See [Styling the shared notes](https://github.com/zadam/trilium/wiki/Sharing#styling-the-shared-notes) ⭐ 37,518 | 🐛 666 | 🌐 TypeScript | 📅 2026-08-20 for
more info.

* [ysslang's theme](https://github.com/zadam/trilium/discussions/2681) ⭐ 37,518 | 🐛 666 | 🌐 TypeScript | 📅 2026-08-20 ![ysslang's theme](https://img.shields.io/github/gist/last-commit/46e2a57ca95ba9c7368cbd255d1ac769)
...
See ([Trilium Wiki](https://github.com/zadam/trilium/wiki/Themes#custom-css) ⭐ 37,518 | 🐛 666 | 🌐 TypeScript | 📅 2026-08-20
for instructions on how to enable custom CSS)

* [display edited notes as list](https://github.com/zadam/trilium/discussions/2670#discussion-3884786) ⭐ 37,518 | 🐛 666 | 🌐 TypeScript | 📅 2026-08-20
* [horizontal scrollbar](https://github.com/zadam/trilium/discussions/4706) ⭐ 37,518 | 🐛 666 | 🌐 TypeScript | 📅 2026-08-20 A css snippet to make the left panel and toc display a horizontal scrollbar.
* [remove numbers from table of contents](https://github.com/zadam/trilium/discussions/3873#discussioncomment-5710601) ⭐ 37,518 | 🐛 666 | 🌐 TypeScript | 📅 2026-08-20
* [vertical lines for tree](https://github.com/zadam/trilium/issues/3892#issuecomment-1530144842) ⭐ 37,518 | 🐛 666 | 🌐 TypeScript | 📅 2026-08-20
...
* [Convert formulas in Note](https://github.com/zadam/trilium/discussions/4792) ⭐ 37,518 | 🐛 666 | 🌐 TypeScript | 📅 2026-08-20
  Convert math formulas wrapped in single dollar signs `$` and double dollar signs `$$` into HTML format within Trilium Notes
* [Scratchpad](https://github.com/zadam/trilium/discussions/1613#discussioncomment-638984) ⭐ 37,518 | 🐛 666 | 🌐 TypeScript | 📅 2026-08-20
...
* [trilium-simple-mind-map](https://github.com/waterovo/trilium-simple-mind-map) ⭐ 36 | 🐛 7 | 🌐 JavaScript | 📅 2025-04-19 ![trilium-simple-mind-map](https://img.shields.io/github/last-commit/waterovo/trilium-simple-mind-map)
  Create [simple-mind-map](https://github.com/wanglin2/mind-map) ⭐ 12,619 | 🐛 132 | 🌐 JavaScript | 📅 2026-08-02 mindmap in Trilium.
...
* [Calendar Sunday First](https://github.com/zadam/trilium/discussions/4540) ⭐ 37,518 | 🐛 666 | 🌐 TypeScript | 📅 2026-08-20
  Use Sunday as first weekday in calendar.
* [Dark-mode-img-color-conversion](https://github.com/zadam/trilium/discussions/4209) ⭐ 37,518 | 🐛 666 | 🌐 TypeScript | 📅 2026-08-20
  Adjusting the images and background colors on the web page to suit a dark theme.
* [Font formatting shortcuts](https://github.com/zadam/trilium/issues/2954#issuecomment-1672431589) ⭐ 37,518 | 🐛 666 | 🌐 TypeScript | 📅 2026-08-20
  Customizable shortcut keys for text formatting in CKEditor. Makes significant enhancement in editing efficiency.
* [Open note in split view](https://github.com/zadam/trilium/discussions/3937) ⭐ 37,518 | 🐛 666 | 🌐 TypeScript | 📅 2026-08-20
...
* [Beatlink's Trilium Scripts](https://github.com/BeatLink/trilium-scripts) ⭐ 58 | 🐛 0 | 🌐 JavaScript | 📅 2026-08-19 A collection of scripts and widgets to do everything from allowing you to set priority colors on Notes, to scripting recurring To-dos.
* [Mobile View](https://github.com/BeatLink/trilium-scripts/tree/main/Mobile%20View) ⭐ 58 | 🐛 0 | 🌐 JavaScript | 📅 2026-08-19 ![Mobile View](https://img.shields.io/github/last-commit/BeatLink/trilium-scripts)
...
* [Trillium Agenda](https://github.com/BeatLink/trilium-agenda) ⭐ 58 | 🐛 0 | 🌐 JavaScript | 📅 2026-08-19 ![Trillium Agenda](https://img.shields.io/github/last-commit/BeatLink/trilium-agenda)
...
* [Run Trilium Server in Termux on Android](https://github.com/zadam/trilium/discussions/4542) ⭐ 37,518 | 🐛 666 | 🌐 TypeScript | 📅 2026-08-20 Your server in your hand.
  Have fun :)
...
* [singlefile2trilium](https://github.com/nil0x42/singlefile2trilium) ⭐ 112 | 🐛 2 | 🌐 Python | 📅 2022-05-26 ![singlefile2trilium](https://img.shields.io/github/last-commit/nil0x42/singlefile2trilium)
  With the power of [SingleFile](https://github.com/gildas-lormeau/SingleFile) ⭐ 22,198 | 🐛 162 | 🌐 JavaScript | 📅 2026-08-05 web extension, you can get a perfect copy
...
Trilium's external API (aka [ETAPI](https://github.com/zadam/trilium/wiki/ETAPI) ⭐ 37,518 | 🐛 666 | 🌐 TypeScript | 📅 2026-08-20) related stuff.
...
* [official wiki](https://github.com/zadam/trilium/wiki) ⭐ 37,518 | 🐛 666 | 🌐 TypeScript | 📅 2026-08-20
